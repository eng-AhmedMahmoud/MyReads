...
1. [Download](https://github.com/eng-AhmedMahmoud/MyReads/archive/master.zip) or [Clone](https://github.com/eng-AhmedMahmoud/MyReads.git) the Repository.
2. Run `npm install` to install the project dependencies.
3. Start the application development server using `npm start`.
